...
'Devoloping , Function , Input , System'

def ElevatorSystem():
    floor = input('What floor do you want to go to')
...
'try'
def rollercoastersystem(age, height):
    #If(Age < 15)    
= Accessible to ride the roller coaster 1

    #Else(Age > 12)
= Unable to ride the roller coaster 1

#If(Age = 14)
= Acessible to ride rollercoaster 2

#Else (Age > 13)
= Unable ride roller coaster 2
