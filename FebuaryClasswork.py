...
A computer program In my words I believe it is a program that helps you tranlsate Computor language . 
# 2. Name three (3) data types
Interger , Boolean , & mapping .
# 3. Name three (3) python Operators
Arithmentic Operator , Comparison Operator , And Logical Operator ,
# 4. In your own words, what is a variable?
From past knowledge I believe a variable Is a Unknown Qualiy or entity . 
# READING PROMPTS
...
I would use the Logical operator for this prompt . 
...
# Which python operator would you use in this situation? Explain why.
I would use the arthmentic Operator for this equations .
...
# Which python operator would you use in this situation? Explain why
 I would use the comparison Operators for this equation .